...
for (let i = 0; i < l; i++) {
    images[i].addEventListener("click", function (i) {
        ...
        function prev() {
            ...
            imgItem.innerHTML = '<img src="' + prevImg.src.replace('thumb', 'large') + '" alt="gallery-image">';
        ...
        function next() {
            ...
            imgItem.innerHTML = '<img src="' + nextImg.src.replace('thumb', 'large') + '" alt="gallery-image">';
